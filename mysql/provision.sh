...
MYSQL_PWD=root mysql -u root -e "CREATE DATABASE dwdb;"
MYSQL_PWD=root mysql -u root dwdb < /vagrant/mysql_tables_create.sql
MYSQL_PWD=root mysql -u root dwdb < /vagrant/mysql_tables_insert.sql
